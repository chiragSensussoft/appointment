...
class _MyBottomSheetState extends State<MyBottomSheet> implements OnHomeView {
  ...
  void initState() {
    super.initState();
    startTime =
        _startDateTime.hour.toString() + ":" + _startDateTime.minute.toString();
          ...
          children: [
            ...
            Container(
              ...
              decoration: InputDecoration(
                  contentPadding: EdgeInsets.only(
                      top: Dimen().dp_10, bottom: Dimen().dp_10, left: 12),
                  ...
                  filled: true,
                  hintText: Resources.from(context, Constant.languageCode)
                      .strings
                      .bottomSheetTfTitle,
                  hintStyle:
            ...
            Container(
              child: FlatButton(
                ...
                child: Text(
                  tempDate ??
                      DateFormat('EE, d MMM, yyyy').format(_currentTime),
                  style: TextStyle(fontSize: 15, fontFamily: 'poppins_medium'),
                ),
              ),
            ),
            ...
            Container(
                margin:
                    EdgeInsets.only(top: Dimen().dp_20, left: 80, right: 80),
                child: FlatButton(
                  child: Text(
                      Resources.from(context, Constant.languageCode)
                          .strings
                          ...
                          child: Row(
                            children: [
                              Container(
                                ...
                                width: 20,
                                child: CircleAvatar(
                                    backgroundColor: widget.itemList[index].id == setEmail
                                            ? Palette.colorPrimary : Colors.grey
                                ),
                              ),
                              Container(
